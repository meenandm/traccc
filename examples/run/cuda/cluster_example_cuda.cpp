...
int clustering_run(const traccc::opts::detector& detector_opts,
...
int main(int argc, char* argv[]) {
    ...
    traccc::opts::program_options program_opts{
        ...
        {detector_opts, input_opts, output_opts, clusterization_opts, performance_opts, accelerator_opts},
        argc,
        argv};

    // Run the application.
    return clustering_run(detector_opts, input_opts, output_opts, clusterization_opts, performance_opts,
                   accelerator_opts);
}
